...
<form class="form-bg" action="trans.php" method="POST">
                ...
                <div id="user">
                    <h2 class="name">Account No</h2>
                        <input type="text" name="accno" placeholder="333333" required>
                </div><br>

                <div>
                    <h2 class="name">Name</h2>
                        <input type="text" name="name" placeholder="Sunny Gaikwad"  required>
                </div><br>
                <div>
                    <h2 class="name">Amount</h2>
                        <input type="number" name="balance" placeholder="10000" required>
                </div><br>
                <div>
